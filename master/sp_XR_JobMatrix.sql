...
GO
CREATE PROCEDURE [dbo].[sp_XR_JobMatrix] 
/*   
	...
	FUTURE ENHANCEMENTS: 
		...
		Debug=1 isn't really usable. =2 is ok, but there are too many result sets w/o any contextual info for =1, so that needs to be cleaned up.
