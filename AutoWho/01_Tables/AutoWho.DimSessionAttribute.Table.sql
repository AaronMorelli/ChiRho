/*
   ...
   limitations under the License.
	...
	FILE NAME: AutoWho.DimSessionAttribute.Table.sql

	TABLE NAME: AutoWho.DimSessionAttribute
	...
	of fields from sys.dm_exec_sessions) observed by AutoWho.Collector
*/
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [AutoWho].[DimSessionAttribute] ADD  CONSTRAINT [DF_AutoWho_DimSessionAttributes_TimeAddedUTC]  DEFAULT (GETUTCDATE()) FOR [TimeAddedUTC]
GO