...
GO
CREATE PROCEDURE [AutoWho].[LogEvent]
/*   
	...
	FILE NAME: AutoWho.LogEvent.StoredProcedure.sql

	PROCEDURE NAME: AutoWho.LogEvent
...
To Execute
------------------------
EXEC AutoWho.LogEvent @ProcID=@@PROCID, @EventCode=0, @TraceID=NULL, @Location='text that identifies the statement we just captured a rowcount for', @Message='The details of what is to be logged.';
*/
(
	@ProcID			INT,
