...
GO
CREATE PROCEDURE [AutoWho].[LogRowCount]
/*   
	...
	FILE NAME: AutoWho.LogRowCount.StoredProcedure.sql

	PROCEDURE NAME: AutoWho.LogRowCount
...
To Execute
------------------------
EXEC AutoWho.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='text that identifies the statement we just captured a rowcount for';
*/
(
	@ProcID			INT,
	@RC				BIGINT,
