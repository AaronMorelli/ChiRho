...
GO
CREATE PROCEDURE [AutoWho].[ResetUserCollectionOptions] 
/*   
	...
	FILE NAME: AutoWho.ResetUserCollectionOptions.StoredProcedure.sql

	PROCEDURE NAME: AutoWho.ResetUserCollectionOptions
	...
	PURPOSE: Deletes the rows in AutoWho.UserCollectionsOptions and re-inserts a row based on default values
...
SELECT * FROM AutoWho.UserCollectionOptions
*/
AS
BEGIN
	SET NOCOUNT ON;
	...
	DISABLE TRIGGER AutoWho.trgDEL_AutoWhoUserCollectionOptions ON AutoWho.UserCollectionOptions;

	DELETE FROM AutoWho.UserCollectionOptions;

	ENABLE TRIGGER AutoWho.trgDEL_AutoWhoUserCollectionOptions ON AutoWho.UserCollectionOptions;

	INSERT [AutoWho].[UserCollectionOptions] (
		[OptionSet],					--1
		[IncludeIdleWithTran], 
		[IncludeIdleWithoutTran], 
		[DurationFilter], 
