/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.trgUPD_ServerEyeOptions.sql

	TRIGGER NAME: ServerEye.trgUPD_ServerEyeOptions
...
GO
CREATE TRIGGER [ServerEye].[trgUPD_ServerEyeOptions] ON [ServerEye].[Options]
