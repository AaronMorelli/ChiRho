/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_resource_governor_resource_pools.Table.sql

	TABLE NAME: ServerEye.dm_resource_governor_resource_pools
...
*/
CREATE TABLE [ServerEye].[dm_resource_governor_resource_pools](
