/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_resource_governor_workload_groups.Table.sql

	TABLE NAME: ServerEye.dm_resource_governor_workload_groups
...
*/
CREATE TABLE [ServerEye].[dm_resource_governor_workload_groups](
