/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_db_index_operational_stats.Table.sql

	TABLE NAME: ServerEye.dm_db_index_operational_stats
...
*/
CREATE TABLE [ServerEye].[dm_db_index_operational_stats](
