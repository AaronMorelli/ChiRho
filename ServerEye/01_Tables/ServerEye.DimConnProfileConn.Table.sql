/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.DimUserProfileConn.Table.sql

	TABLE NAME: ServerEye.DimUserProfileConn
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[DimUserProfileConn](
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKDimUserProfileConn] ON [ServerEye].[DimUserProfileConn](
	[net_transport],
	[protocol_type],
	[protocol_version],
	[endpoint_id],
