/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_os_memory_cache_clock_hands.Table.sql

	TABLE NAME: ServerEye.dm_os_memory_cache_clock_hands
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[dm_os_memory_cache_clock_hands](
