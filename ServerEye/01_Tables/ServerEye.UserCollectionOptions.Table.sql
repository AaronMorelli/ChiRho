/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.UserCollectionOptions.Table.sql

	TABLE NAME: ServerEye.UserCollectionOptions
...
GO
CREATE TABLE [ServerEye].[UserCollectionOptions](
...
GO
--ALTER TABLE [ServerEye].[UserCollectionOptions]  WITH CHECK ADD  CONSTRAINT [CK_SEUserCollectionOptions_OptionSet] CHECK  (([OptionSet]=N'SessionViewerFull' OR [OptionSet]=N'SessionViewerCommonFeatures' OR [OptionSet]=N'SessionViewerInfrequentFeatures' OR [OptionSet]=N'SessionViewerMinimal' OR [OptionSet]=N'QueryProgress'))
--GO
--ALTER TABLE [ServerEye].[UserCollectionOptions] CHECK CONSTRAINT [CK_SEUserCollectionOptions_OptionSet]
--GO
ALTER TABLE [ServerEye].[UserCollectionOptions]  WITH CHECK ADD  CONSTRAINT [CK_SEUserCollectionOptionsDebugSpeed] CHECK  (([DebugSpeed]=N'Y' OR [DebugSpeed]=N'N'))
GO
ALTER TABLE [ServerEye].[UserCollectionOptions] CHECK CONSTRAINT [CK_SEUserCollectionOptionsDebugSpeed]
GO
