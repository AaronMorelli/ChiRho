/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.RingBufferCausedExceptions.Table.sql

	TABLE NAME: ServerEye.RingBufferCausedExceptions
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[RingBufferCausedExceptions](
