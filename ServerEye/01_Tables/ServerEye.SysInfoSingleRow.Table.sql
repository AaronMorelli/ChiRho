/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.SysInfoSingleRow.Table.sql

	TABLE NAME: ServerEye.SysInfoSingleRow
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[SysInfoSingleRow](
	[UTCCaptureTime]					[datetime] NOT NULL,
	[LocalCaptureTime]					[datetime] NOT NULL,
	[StableOSIID]						[int] NOT NULL,	--a pointer to the "current" row in ServerEye.dm_os_sys_info_stable
