/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.DimPerformanceCounter.Table.sql

	TABLE NAME: ServerEye.DimPerformanceCounter
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[DimPerformanceCounter](
...
GO
ALTER TABLE [ServerEye].[DimPerformanceCounter]  WITH CHECK ADD  CONSTRAINT [CK_DimPerformanceCounterCounterFrequency] CHECK  (([CounterFrequency]=0 OR [CounterFrequency]=1 OR [CounterFrequency]=2 OR [CounterFrequency]=3))
GO
ALTER TABLE [ServerEye].[DimPerformanceCounter] CHECK CONSTRAINT [CK_DimPerformanceCounterCounterFrequency]
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKDimPerformanceCounter] ON [ServerEye].[DimPerformanceCounter]
(
	[object_name],
	[counter_name],
	[instance_name]
...
GO
CREATE CLUSTERED INDEX CL_CounterFrequency ON [ServerEye].[DimPerformanceCounter]
(
