/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.DimMemoryTracker.Table.sql

	TABLE NAME: ServerEye.DimMemoryTracker
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[DimMemoryTracker](
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKLatchClass] ON [ServerEye].[DimMemoryTracker]
(
