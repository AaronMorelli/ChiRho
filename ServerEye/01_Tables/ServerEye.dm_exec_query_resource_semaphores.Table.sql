/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_exec_query_resource_semaphores.Table.sql

	TABLE NAME: ServerEye.dm_exec_query_resource_semaphores
...
*/
CREATE TABLE [ServerEye].[dm_exec_query_resource_semaphores](
