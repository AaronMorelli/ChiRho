/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.dm_os_memory_cache_counters.Table.sql

	TABLE NAME: ServerEye.dm_os_memory_cache_counters
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[dm_os_memory_cache_counters](
