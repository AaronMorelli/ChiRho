/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.DimDBVolume.Table.sql

	TABLE NAME: ServerEye.DimDBVolume
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[DimDBVolume](
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKDimDBVolume] ON [ServerEye].[DimDBVolume]
(
	[volume_id] ASC,
