/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.RingBufferSecurityError.Table.sql

	TABLE NAME: ServerEye.RingBufferSecurityError
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[RingBufferSecurityError](
...
GO
CREATE CLUSTERED INDEX CL1 ON [ServerEye].[RingBufferSecurityError](UTCCaptureTime);
GO