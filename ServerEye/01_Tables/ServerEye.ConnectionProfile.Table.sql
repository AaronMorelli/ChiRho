/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.ConnectionProfile.Table.sql

	TABLE NAME: ServerEye.ConnectionProfile
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[ConnectionProfile](
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AKConnectionProfile] ON [ServerEye].[ConnectionProfile](
	[UTCCaptureTime],
	[LocalCaptureTime],
