/*
   ...
   limitations under the License.
	...
	FILE NAME: ServerEye.RingBufferConnectivity.Table.sql

	TABLE NAME: ServerEye.RingBufferConnectivity
...
SET ANSI_PADDING ON
GO
CREATE TABLE [ServerEye].[RingBufferConnectivity](
...
GO
CREATE CLUSTERED INDEX CL1 ON [ServerEye].[RingBufferConnectivity](UTCCaptureTime);
GO