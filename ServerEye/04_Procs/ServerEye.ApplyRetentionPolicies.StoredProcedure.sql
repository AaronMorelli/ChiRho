		...
		*/
		...
		BEGIN
			...
			OPTION(FORCE ORDER, RECOMPILE);
						...
						EXEC ServerEye.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='Rows deleted from CoreXR.InputBufferStore.';
		END
		*/
		...
		BEGIN
			...
			OPTION(FORCE ORDER, RECOMPILE);
						...
						SET @lv__RowCount = ROWCOUNT_BIG();
						EXEC ServerEye.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='Rows deleted from CoreXR.QueryPlanBatchStore.';
		END
		*/
		...
		BEGIN
			...
			OPTION(FORCE ORDER, RECOMPILE);
						...
						SET @lv__RowCount = ROWCOUNT_BIG();
						EXEC ServerEye.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='Rows deleted from CoreXR.QueryPlanStmtStore.';
		END
		*/
		...
		BEGIN
			...
			OPTION(FORCE ORDER, RECOMPILE);
						...
						SET @lv__RowCount = ROWCOUNT_BIG();
						EXEC ServerEye.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='Rows deleted from CoreXR.SQLBatchStore.';
		END
		...
		*/
		...
		BEGIN
			...
			OPTION(FORCE ORDER, RECOMPILE);
						...
						SET @lv__RowCount = ROWCOUNT_BIG();
						EXEC ServerEye.LogRowCount @ProcID=@@PROCID, @RC=@lv__RowCount, @TraceID=NULL, @Location='Rows deleted from CoreXR.SQLStmtStore.';
		END
		*/
